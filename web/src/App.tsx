...
import { computeNotifications, NotificationPanel, MobileNotificationBell } from './components/common/NotificationCenter';
          ...
          <div className="flex-1 flex flex-col min-w-0">
            ...
            <main className="flex-1 flex flex-col min-h-0">
              ...
              <div className="flex-1 min-h-0 overflow-y-auto pb-24 md:pb-0">
                <div className="p-4 md:px-8 md:py-8 lg:px-10 lg:py-10 flex flex-col h-full min-h-full">
...
function ContractorRoutes() {
  ...
  return (
    <Routes>
      ...
      <Route
        path="clients/:id"
        element={<ClientDetail workItems={workItems} clients={clients} apps={apps} hourlyRate={settings.hourlyRate} />}
      />
      <Route
        path="apps"
